...
namespace AlborzNirooPartsMonitoringSystem.Models
{
    ...
    public class ApplicationDbContext : IdentityDbContext<ApplicationUser>
    {
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Part>().HasOptional(z => z.ParentPart).WithMany(z => z.ChildParts).HasForeignKey(z => z.ParentPartId);
